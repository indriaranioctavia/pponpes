    ...
    <div class="flex-fill d-flex flex-column justify-content-center py-4">
        <div class="container-tight py-6">
            <div class="text-center mb-4">
                ...
                <h1>Pesantren Cemerlang An-Najach</h1>
                <small class="text-muted">by <strong>Cemerlang</strong></small>
            </div>
            <?= form_open('', ['class' => 'card card-md', 'autocomplete' => 'off']); ?>
            <div class="card-body">
                <?= $this->session->flashdata('msg'); ?>
                <h2 class="card-title text-center mb-4">Daftar sebagai member</h2>
                <div class="mb-3">
                    <label class="form-label">Nama lengkap</label>
                    <input autofocus onfocus="this.select()" value="<?= set_value('fullname'); ?>" name="fullname" type="text" class="form-control" placeholder="Masukkan nama lengkap Anda">
                    <?= form_error('fullname'); ?>
                </div>
                <div class="mb-3">
                    <label class="form-label">Username</label>
                    <input value="<?= set_value('username'); ?>" name="username" type="text" class="form-control" placeholder="Masukkan username Anda">
                    <?= form_error('username'); ?>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">
                        <input name="password2" type="password" class="form-control" placeholder="Konfirmasi password Anda" autocomplete="off">
                        <span class="input-group-text">
                            <a href="#" class="link-secondary" title="Show password" data-toggle="tooltip"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <circle cx="12" cy="12" r="2" />
            ...
            <div class="text-center text-muted mt">
                Sudah memiliki akun? <a href="<?= base_url("signin"); ?>" tabindex="-1">Daftar</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
