                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
                        <a href="<?= base_url('configuration/account'); ?>" class="dropdown-item">
                            <i class="fa fa-user-circle fa-fw mr-2"></i> Akun saya
                        </a>
                        ...
                        <a href="#logoutModal" class="dropdown-item" data-toggle="modal">
                            <i class="fa fa-sign-out-alt fa-fw mr-2"></i> Keluar
                        </a>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                        <?php if (userdata()->role == "admin") : ?>
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('content'); ?>" class="nav-link <?= active_menu('content'); ?>">
                                    <i class="nav-icon fas fa-comments fa-fw"></i>
                                    <p>Kategori2</p>
                                </a>
                            </li>
