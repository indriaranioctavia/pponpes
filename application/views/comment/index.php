...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title">Semua <?= $title; ?></h5>
                    ...
                    <tr>
                        ...
                        <td width="180" class="align-middle text-right">
                            <div class="btn-group">
                                ...
                                ?>
                                <a target="_blank" href="<?= $view; ?>" class="btn btn-default btn-sm"><i class="fa fa-eye"></i> Lihat</a>
                                <a href="<?= base_url('comment/delete/') . $row->comment_id; ?>" onclick="return confirm('Confirm Delete ?');" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
