<?php if (userdata()) : ?>
    ...
    <div class="card mb-3">
        <div class="card-body">
            <h3 class="card-title">Masukkan komentar</h3>
            <textarea class="form-control" rows="4" name="comment_body" placeholder="Ketikkan disini"></textarea>
                                ...
                                <?php if (userdata()) : ?>
                                    ...
                                    <div class="collapse" id="reply-box-<?= $c->comment_id; ?>">
                                        ...
                                        <div class="card mb-3 bg-light">
                                            ...
                                            <div class="card-body">
                                                <h3 class="card-title">Tuliskan balasan</h3>
