        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="<?= base_url('dashboard'); ?>" class="btn btn-sm btn-default">Kembali</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="avatar" data-browse="Browse">Pilih file ...</label>
                    </div>
                    <?= form_error('avatar'); ?>
                </div>
                <button type="submit" class="btn bg-primary btn-block">Simpan</button>
                <?= form_close(); ?>
            </div>
        </div>
    </div>
