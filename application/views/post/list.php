...
<div class="page-header d-print-none">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">
                <?= $selected_category ? "Category: " . get_category($selected_category) : "Semua postingan"; ?>
            </h2>
        </div>
    </div>
</div>
...
<?php if (!$posts) : ?>
    <div class="row justify-content-center">
        <div class="col-md-6 text-center">
            <div class="alert alert-warning">Postingan tidak ditemukan. <br> <a href="<?= base_url(); ?>" class="badge bg-danger">Tampilkan semua</a></div>
        </div>
    </div>
<?php endif; ?>
